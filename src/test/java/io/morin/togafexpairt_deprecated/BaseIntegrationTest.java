package io.morin.togafexpairt_deprecated;
...
public abstract class BaseIntegrationTest {
    ...
    static void beforeAll() {
        ...
        System.setProperty("togafexpairt_deprecated.qdrant.host", QADRANT.getHost());
        System.setProperty("togafexpairt_deprecated.qdrant.port", String.valueOf(QADRANT.getFirstMappedPort()));

        // ollama configuration
        System.setProperty(
            "togafexpairt_deprecated.ollama.base_url",
            String.format("http://%s:%d", OLLAMA.getHost(), OLLAMA.getFirstMappedPort())
        );

        // langchain4j configuration
        System.setProperty("togafexpairt_deprecated.langchain4j.embedding_model", "MINI_LM");
        System.setProperty("togafexpairt_deprecated.langchain4j.dimension", "384");
    }
}
